...
resource "aws_instance" "sut" {
  ...
  provisioner "file" {
    ...
    destination = "/home/ubuntu/noma.jar"
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo apt-get -qq install openjdk-11-jre pip",
      "pip install -q --user pipenv",
...
resource "aws_instance" "bedrock" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo apt-get -qq install wget cl-ppcre libpcrecpp0v5",
